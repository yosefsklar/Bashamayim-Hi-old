...
var decoyWords = ecc.join(" ").replace(/[\u0591-\u05AF\u05c0]|\(פ\)|\(ס\)|\[(.*?)]/g, "").split(/[\s\u05BE]+/);
...
var textWords = genesis.join(" ").replace(/[\u0591-\u05AF\u05c0]|\(פ\)|\(ס\)|\[(.*?)]/g, "").split(/[\s\u05BE]+/);
console.log(textWords)

decoyWords = decoyWords.filter(x => !textWords.includes(x));
